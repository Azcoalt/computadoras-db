...
var serviceAccount = require("../../db-node-firebase-admi-computer-firebase-adminsdk-colfq-ededf63736.json");

admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: 'https://db-node-firebase-admi-computer-default-rtdb.firebaseio.com/'
});
